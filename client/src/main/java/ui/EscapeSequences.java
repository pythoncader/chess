...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_GRAY = SET_TEXT_COLOR + "250m";
    ...
    public static final String SET_BG_COLOR_GREEN = SET_BG_COLOR + "2m";
    ...
    public static final String SET_BG_COLOR_GRAY = SET_BG_COLOR + "250m";
